...
class Funding {
  ...
  Funding(this.symbol, this.fullName, this.retCode, this.dealId, this.volumeRemaining, this.price,);

  Funding.success(this.symbol, this.fullName, this.dealId, this.volumeRemaining, this.price,) : retCode = RET_CODE.DONE;
